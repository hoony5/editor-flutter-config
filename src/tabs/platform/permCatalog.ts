...
var PERM_META={
camera:{links:[['Apple Docs','https://developer.apple.com/documentation/avfoundation/capture_setup'],['Android Docs','https://developer.android.com/training/camera2']],acts:[],pkgs:[],impact:'Runtime crash on camera access. App Store rejection if missing.'},
mic:{links:[['Apple Docs','https://developer.apple.com/documentation/avfoundation/audio_capture']],acts:[],pkgs:[],impact:'Audio recording silently fails. Required for voice features.'},
bt:{links:[['Apple BLE','https://developer.apple.com/bluetooth/'],['Android BLE','https://developer.android.com/develop/connectivity/bluetooth/btle']],acts:[],pkgs:['flutter_reactive_ble'],impact:'Bluetooth scanning/connecting fails silently on Android 12+.'},
loc:{links:[['Apple Location','https://developer.apple.com/documentation/corelocation'],['Android Location','https://developer.android.com/develop/sensors-and-location/location']],acts:[],pkgs:['geolocator'],impact:'Location returns null or throws. Background location requires separate justification.'},
contacts:{links:[['Apple Contacts','https://developer.apple.com/documentation/contacts']],acts:[],pkgs:['contacts_service'],impact:'Contact picker returns empty. No error thrown.'},
cal:{links:[['Apple EventKit','https://developer.apple.com/documentation/eventkit']],acts:[],pkgs:['device_calendar'],impact:'Calendar access denied. Events not readable.'},
health:{links:[['Apple HealthKit','https://developer.apple.com/documentation/healthkit']],acts:[],pkgs:['flutter_health'],impact:'HealthKit queries return empty. Requires HealthKit capability in Xcode.'},
photos:{links:[['Apple PhotoKit','https://developer.apple.com/documentation/photokit'],['Android Media','https://developer.android.com/training/data-storage/shared/media']],acts:[],pkgs:['image_picker','photo_manager'],impact:'Image picker returns null. iOS 14+ shows limited library picker.'},
music:{links:[['Apple MusicKit','https://developer.apple.com/documentation/musickit']],acts:[],pkgs:[],impact:'Apple Music catalog access denied.'},
speech:{links:[['Apple Speech','https://developer.apple.com/documentation/speech']],acts:[],pkgs:['speech_to_text'],impact:'Speech recognition silently fails.'},
biometric:{links:[['Apple LocalAuth','https://developer.apple.com/documentation/localauthentication'],['Android Biometric','https://developer.android.com/training/sign-in/biometric-auth']],acts:[],pkgs:['local_auth'],impact:'Authentication dialog never appears. local_auth throws.'},
tracking:{links:[['Apple ATT','https://developer.apple.com/documentation/apptrackingtransparency']],acts:[],pkgs:['app_tracking_transparency'],impact:'ATT dialog not shown. Ad tracking ID returns zeros.'},
inet:{links:[['Android Network','https://developer.android.com/training/basics/network-ops']],acts:[],pkgs:[],impact:'All network requests fail on Android. macOS app cannot make outbound connections.'},
notif:{links:[['Android Notif','https://developer.android.com/develop/ui/views/notifications'],['Firebase FCM','https://firebase.google.com/docs/cloud-messaging/flutter/client']],acts:[['flutterfire configure','dart pub global activate flutterfire_cli && flutterfire configure']],pkgs:['firebase_messaging','flutter_local_notifications'],impact:'Push notifications silently not delivered on Android 13+.'},
push:{links:[['Firebase FCM','https://firebase.google.com/docs/cloud-messaging/flutter/client'],['FlutterFire','https://firebase.flutter.dev/docs/messaging/overview'],['APNs Setup','https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server']],acts:[['flutterfire configure','dart pub global activate flutterfire_cli && flutterfire configure']],pkgs:['firebase_messaging','firebase_core'],iosReq:'aps-environment entitlement + Xcode Push Notifications capability',androidReq:'FCM SDK (google-services.json)',impact:'Remote push not received. Requires APNs certificate (iOS) or FCM setup (Android).'},
alarm:{links:[['Android AlarmManager','https://developer.android.com/reference/android/app/AlarmManager']],acts:[],pkgs:['android_alarm_manager_plus'],impact:'Exact alarms not fired on Android 12+. User must opt in.'},
boot:{links:[['Android BootReceiver','https://developer.android.com/reference/android/content/Intent#ACTION_BOOT_COMPLETED']],acts:[],pkgs:[],impact:'App not started after device reboot.'},
bgmode:{links:[['Apple Background','https://developer.apple.com/documentation/backgroundtasks'],['Flutter Background','https://docs.flutter.dev/develop/platform-integration/background-processes']],acts:[],pkgs:['workmanager'],impact:'Background tasks not executed. iOS terminates app for background violations.'},
fgsvc:{links:[['Android ForegroundService','https://developer.android.com/develop/background-work/services/foreground-services']],acts:[],pkgs:['flutter_foreground_task'],impact:'Background service killed immediately on Android 9+.'},
storage:{links:[['Android Storage','https://developer.android.com/training/data-storage'],['Apple Files','https://developer.apple.com/documentation/fileprovider']],acts:[],pkgs:['path_provider','permission_handler'],impact:'File read/write fails on Android 10+. Scoped storage enforced.'},
local:{links:[['Apple NetworkExtension','https://developer.apple.com/documentation/networkextension']],acts:[],pkgs:[],impact:'LAN device discovery fails. iOS shows consent dialog.'},
sandbox:{links:[['Apple Sandbox','https://developer.apple.com/documentation/security/app_sandbox']],acts:[],pkgs:[],impact:'macOS App Store rejection without sandbox.'},
overlay:{links:[['Android Overlay','https://developer.android.com/reference/android/view/WindowManager.LayoutParams#TYPE_APPLICATION_OVERLAY']],acts:[],pkgs:[],impact:'Overlay window not shown. SYSTEM_ALERT_WINDOW requires special approval.'},
siri:{links:[['Apple SiriKit','https://developer.apple.com/documentation/sirikit']],acts:[],pkgs:[],impact:'Siri shortcuts not available.'},
homekit:{links:[['Apple HomeKit','https://developer.apple.com/documentation/homekit']],acts:[],pkgs:[],impact:'HomeKit accessory discovery fails.'},
gamecenter:{links:[['Apple GameKit','https://developer.apple.com/documentation/gamekit']],acts:[],pkgs:[],impact:'Game Center friend list not accessible.'},
tvprov:{links:[['Apple TVServices','https://developer.apple.com/documentation/tvservices']],acts:[],pkgs:[],impact:'TV provider account access denied.'},
motion:{links:[['Apple CoreMotion','https://developer.apple.com/documentation/coremotion'],['Android Sensors','https://developer.android.com/develop/sensors-and-location/sensors/sensors_overview']],acts:[],pkgs:['sensors_plus'],impact:'Sensor data returns zero or throws. High-frequency access drains battery.'},
};
const PC=[
